...
<%--                <td><a href="/request/detail/${con.conNo}">${con.conRequest}</a></td>--%>
               <c:choose>
                ...
                <c:when test="${con.conCondition == 2}"> <td>계약중</td></c:when>
                <c:when test="${con.conCondition == 3}"> <td>계약승인</td></c:when>
                <c:when test="${con.conCondition == 4}"> <td>계약완료</td></c:when>
                <c:when test="${con.conCondition == 5}"> <td>시공완료</td></c:when>
                <c:when test="${con.conCondition == 6}"> <td>종료된 의뢰</td></c:when>
